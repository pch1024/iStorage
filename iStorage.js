(function (definition) {
    ...
    if (typeof exports === "object" && typeof module === "object") {
        ...
        throw new Error("This environment was not anticipated by iStorage,Please file a bug.");
    }
})(function () {
    ...
    function IStorage() {
        ...
        this.tip = "value only support Number(Do not include NaN)、String、Array、JSON ！But you gave ：";
    }
